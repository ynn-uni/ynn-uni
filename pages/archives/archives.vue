              ...
              <view class="form">
                <view class="cu-form-group">
                  <bjx-form-item labelType="inline" label="姓名:" prop="truename" > 
                      <input  v-model="form.truename" class="input" name="truename" placeholder="请输入您的姓名" type="text" />
                  </bjx-form-item>
                </view>
                <view class="cu-form-group">
                  <bjx-form-item labelType="inline" label="手机:" prop="phone" > 
                      <input  v-model="form.phone" class="input" name="phone" placeholder="请输入您的电话号码" type="number"/>
                  </bjx-form-item>
                </view>
                <view class="cu-form-group">
                  <bjx-form-item labelType="inline" label="生日:" prop="birthday" >
                    <picker name="birthday" mode="date" @change="handleBirthChange" v-model="form.birthday">
                ...
                <view class="cu-form-group">
                  <bjx-form-item labelType="inline" label="身高：" prop="height" >
                    <view class="flex justify-between align-center">
                      <input  v-model="form.height" class="input" name="height" placeholder="请输入您的身高" type="number" /><text>CM</text>
                    </view>
                  </bjx-form-item>
                </view>
                <view class="cu-form-group">
                  <bjx-form-item labelType="inline" label="体重：" prop="weight" >
                    <view class="flex justify-between align-center">
                      <input  v-model="form.weight" class="input" name="weight" placeholder="请输入您的体重" type="number" /><text>KG</text>
                    </view>
                  </bjx-form-item>
                </view>
              </view>
              <view class="submit-btn">
              	<button form-type="submit" @tap="submit"  class="cu-btn round lg bg-primary"> {{ hasInfo ? '修改' : '提交' }}</button>
              </view>
          </bjx-form>
        </view>
